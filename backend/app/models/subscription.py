...
class Subscription(Model):
    ...
    user = fields.ForeignKeyField('models.User', related_name='subscriptions', description="User who owns this subscription")
    name = fields.CharField(max_length=255, description="Subscription name")
    price = fields.DecimalField(max_digits=10, decimal_places=2, description="Subscription price")
    currency = fields.CharField(max_length=10, default='RUB', description="Currency code")
